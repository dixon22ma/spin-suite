 ...
 *  @contributor <a href="mailto:yamelsenih@gmail.com">Yamel Senih</a> 22/03/2014, 14:34:04
 *  <li> Support to Mobile
 */
public class AmtInWords_ES implements AmtInWords
{
	...
	public String getAmtInWords (String amount) throws Exception {
		if (amount == null)
			return amount;
		//	Yamel Senih 2014-03-22, 14:52:54
		//	Add Support to Android locale
		DecimalFormatSymbols sym = DecimalFormatSymbols.getInstance(Locale.getDefault());
		//	
		char decimalSeparator = sym.getDecimalSeparator();
		
		//
		StringBuffer sb = new StringBuffer ();
		int pos = 0;

		pos = amount.lastIndexOf (decimalSeparator);    // Old
		//	
		int pos2 = 0;
		pos2 = amount.lastIndexOf (decimalSeparator);
		...
		int newpos = 0;
		newpos = amount.lastIndexOf (decimalSeparator);
