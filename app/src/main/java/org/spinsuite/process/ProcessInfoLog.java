...
public class ProcessInfoLog {
	 ...
	 */
	public ProcessInfoLog (int P_ID, Date P_Date, BigDecimal P_Number, String P_Msg){
	 ...
	 *	@param P_Msg Process Messagre
	 */
	public ProcessInfoLog (int Log_ID, int P_ID, Date P_Date, BigDecimal P_Number, String P_Msg){
		setLog_ID (Log_ID);
		setP_ID (P_ID);
		setP_Date (P_Date);
